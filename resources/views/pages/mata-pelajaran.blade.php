              ...
              <tr>
                ...
                <td>
                  <div class="btn-group" role="group" aria-label="Basic example">
                    ...
                    <button type="button" class="btn btn-sm table-action table-action-delete" data-toggle="modal" data-target="#hapus-mapel-{{ $item->id }}">
...
@include('includes.modal.mata-pelajaran-modal')
@endsection